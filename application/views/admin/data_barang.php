<div class="container-fluid">
  ...
  <table class="table table-bordered">
		...
		<tr>
			...
			<td align="center"><?php echo anchor('admin/data_barang/detail/'. $brg->id_barang, '<div class="btn btn-sm btn-success"><i class="fas fa-search-plus"></i></div>') ?></div></td>
			...
			<td onclick="javascript: return confirm('Anda Yakin Ingin Menghapus?')"><?php echo anchor('admin/data_barang/hapus/'.$brg->id_barang, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
		</tr>
