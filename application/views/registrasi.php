                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <p align="center"><img src="<?php echo base_url('assets/img/logo kabupaten magelang.png') ?>"class="d-block w-30" height="50">
                                <h1 class="h4 text-gray-900 mb-4"><b>DAFTAR AKUN BARU</b></h1>
                            </div>
                            <form method="post" action="<?php echo base_url('registrasi/index'); ?>" class="user">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Nama Lengkap Anda" name="nama">
